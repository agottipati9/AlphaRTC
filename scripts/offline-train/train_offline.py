...
def get_config():
    ...
    parser.add_argument("--run_name", type=str, default="Local_IQL", help="Name of the run, default: IQL")
...
def train(config):
    ...
    for i in range(1, config.episodes+1):
        ...
        for batch_idx, experience in enumerate(dataloader):
            ...
            # debug metrics
            metrics['mean_action'] += misc['mean_action']
            metrics['std_action'] += misc['std_action']
